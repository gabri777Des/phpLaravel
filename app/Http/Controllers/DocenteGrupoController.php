...
class DocenteGrupoController extends Controller
{
    ...
    public function create()
    {
        $docentes = Docente::all();
        $grupos = Grupo::all();
        return view('docentes_grupo.create', compact('docentes', 'grupos'));
    }
    ...
    {
        $docentesGrupo = DocenteGrupo::create($request->all());
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('docentes_grupos.index')->with('success', 'Docente grupo eliminado.');
    }
}
